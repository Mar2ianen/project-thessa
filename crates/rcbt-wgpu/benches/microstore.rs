...
fn main() {
    ...
    println!("microstore Phase B: {SIZE}x{SIZE} scalar field, {ITERS} iters (dispatch+readback)");
    println!(
        "{:>10} {:>10} {:>10} {:>10} {:>10} {:>10}",
        "fixture.mode", "gpu-ms", "up-B", "res-B", "B/tex", "maxerr"
    );
    ...
    for (fixture_name, field) in fixtures::all(SIZE, SIZE) {
        for (mode_name, mode) in &modes {
            ...
            println!(
                "{fixture_name}.{mode_name:>6} {:>10.3} {:>10} {:>10} {:>10.3} {:>10.1}",
                ms,
                up,
                resident,
    ...
    let field = fixtures::noise(SIZE, SIZE, 0xA8);
