...
pub use propulsion::{
    ...
    CompiledElectricThruster, CompiledEngine, CompiledEstoc, CompiledJet, CompiledLiquid,
    CompiledMonoprop, CompiledPistonEngine, CompiledPropeller, CompiledPropellerDrive,
    CompiledPropulsionSystem, CompiledShaftPowerSource, CompiledSolid, CompiledTurbopropDrive,
