...
Карты v1 сгенерированы встроенным ImageGen 2026-09-07 по отдельным
...
Текстура Thessa v2 получена из детерминированного поля генератора, не ImageGen.
Она используется общим материалом Thessa и в карте, и в режиме полёта.
Векторные иконки приборов: `ui/flight/`, оригинальные исходники SVG и PNG 4x,
GPL-3.0-or-later. Интерактивные состояния окрашиваются клиентом.
