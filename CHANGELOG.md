...
- Объёмный факел больше не рисует молочную простыню шире тела струи:
  вес среды жёстко обрезан вне истинного радиуса бочки, турбулентность
  идёт по азимуту (фиксированный базис от оси) на низких частотах вместо
  осесимметричных колец, шок-ячейки смягчены, шаги марша 8/14
  (Medium/High). Хвост растворяется к `z = len` вместо плоского среза,
  `atan2` у оси защищён от NaN на строгих драйверах. Проверено скринами сбоку и сверху-сзади: круглый ствол
  с ярким ядром, без полос и шума.
