...
pub use propulsion::{
    ...
    EnginePlumeState, EngineSpool, EstocMode, EstocPoint, EstocSpec, FlightCondition,
    FusionReaction, FusionTorchCommand, FusionTorchMount, FusionTorchOperatingPoint,
    FusionTorchSpec, GeneratorSpec, GimbalEffector, IntakeKind, JetCommand, JetFuel, JetMount,
    ...
    PulsedFusionCommand, PulsedFusionMount, PulsedFusionOperatingPoint, PulsedFusionSpec,
    PulsedFusionState, RCS_DEFAULT_MIN_ON_TIME_S, RCS_DEFAULT_RISE_TIME_S, RcsCluster, RcsMount,
    RcsPulse, RcsThruster, SEPARATION_PRESSURE_RATIO, STANDARD_GRAVITY_MPS2, ShaftBalance,
    ShaftCommand, ShaftPowerSourceSpec, ShaftSpec, ShaftTelemetry, SolidGrainGeometry,
    SolidMotorSpec, StarterKind, StarterSpec, SystemAltitudePoint, SystemMount,
...
pub use vehicle::{
    ControlKind, ControlSurfaceDefinition, FoldJointRecord, StatefulPulsedFusionWrench,
    StatefulTurbopropWrench, VehicleDefinition, VehicleError, X15StarterProfile,
