...
lifting-body-plus-wing baker fixture exercises the runtime boundary with a
rounded upper surface, flattened chined belly, nose droop, and independently
controllable pitch/yaw body strips. Integration regressions check the lift shift
against a straight-centerline body and the pitch moment generated by the aft
hinged strip.
