...
- [Procedural landing gear and rover wheels](05_PROCEDURAL_LANDING_GEAR.md) — parameterized wheel chassis, pneumatic/airless tires, suspension struts, brake actuators, optional electric drives, and Rapier contact integration.
