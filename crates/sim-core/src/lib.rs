...
pub use propulsion::{
    ...
    NtrSupplement, NuclearThermalSpec, PistonEngineSpec, PistonOperatingPoint,
    PropDriveAltitudePoint, PropDrivePoint, Propellant, PropellantThermo, PropellerDriveCommand,
    PropellerDriveMount, PropellerDriveSpec, PropellerPoint, PropellerSpec, PropulsionError,
    PropulsionSystemSpec, PulsedFusionCommand, PulsedFusionMount, PulsedFusionOperatingPoint,
    PulsedFusionSpec, PulsedFusionState, RCS_DEFAULT_MIN_ON_TIME_S, RCS_DEFAULT_RISE_TIME_S,
